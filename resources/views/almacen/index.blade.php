    ...
    <div class="row">
                        ...
                        <div class="col-md-5">
                            <ul class="list-unstyled small">
                                ...
                                <li class="mb-2 d-flex justify-content-between border-bottom pb-1">
                                    <span><span class="badge-dot" style="background-color: {{ $cat->color }}"></span> {{ $cat->nombre }}</span>
        ...
        <div class="col-lg-6 mb-4">
            <div class="row g-3">
                ...
                <div class="col-6">
                    <a href="#" class="btn btn-light border p-4 w-100 h-100 d-flex flex-column align-items-center justify-content-center shadow-sm">
                        <i class="fas fa-clipboard-list fa-2x text-navy mb-2"></i>
                        <span class="fw-bold text-navy text-uppercase small">Toma de Inventario</span>
                    </a>
                </div>
            </div>
        </div>
