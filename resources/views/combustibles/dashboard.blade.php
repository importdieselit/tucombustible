...
<div class="container py-5">
    ...
    <div class="row g-4 justify-content-center">
        ...
        <div class="col-md-5">
            <div class="card h-100 shadow-sm border-0 card-modulo transition-all" style="border-top: 4px solid #ff6600 !important;">
                <div class="card-body p-4 d-flex flex-column align-items-center text-center">
                    ...
                    <p class="text-muted small mb-4 flex-grow-1">
                        Registro detallado de todas las transacciones de combustible.
                    </p>
                    <a href="{{ route('combustibles.transacciones.index') }}" class="btn btn-warning w-100 fw-black text-uppercase py-2 shadow-sm text-dark" style="background-color: #ff6600; border-color: #ff6600; font-size: 12px; letter-spacing: 0.5px;">
                        <i class="fas fa-clipboard-check me-1"></i> Abrir Llenado
                    </a>
                </div>
            </div>
        ...
        <div class="col-md-5">
            <div class="card h-100 shadow-sm border-0 card-modulo transition-all" style="border-top: 4px solid #ff6600 !important;">
                <div class="card-body p-4 d-flex flex-column align-items-center text-center">
                    ...
                    <a href="{{ route('combustibles.consumos_operativos.index') }}" class="btn btn-warning w-100 fw-black text-uppercase py-2 shadow-sm text-dark" style="background-color: #ff6600; border-color: #ff6600; font-size: 12px; letter-spacing: 0.5px;">
                        <i class="fas fa-clipboard-check me-1"></i> Abrir Llenado
                    </a>
                </div>
            </div>
        ...
        <div class="col-md-5">
            <div class="card h-100 shadow-sm border-0 card-modulo transition-all" style="border-top: 4px solid #ff6600 !important;">
                <div class="card-body p-4 d-flex flex-column align-items-center text-center">
                    ...
                    <a href="{{ route('combustibles.trasegados.index') }}" class="btn btn-warning w-100 fw-black text-uppercase py-2 shadow-sm text-dark" style="background-color: #ff6600; border-color: #ff6600; font-size: 12px; letter-spacing: 0.5px;">
                        <i class="fas fa-clipboard-check me-1"></i> Abrir Llenado
                    </a>
                </div>
            </div>
        ...
        {{-- OPCIÓN 7: REVERSOS DE COMBUSTIBLES --}}
        <div class="col-md-5">
            <div class="card h-100 shadow-sm border-0 card-modulo transition-all" style="border-top: 4px solid #ff6600 !important;">
                <div class="card-body p-4 d-flex flex-column align-items-center text-center">
                    <div class="bg-light rounded-circle p-3 mb-3 d-flex align-items-center justify-content-center shadow-inner" style="width: 70px; height: 70px;">
                    ...
                    <h5 class="fw-black text-uppercase text-dark mb-2" style="font-size: 16px; letter-spacing: 0.5px;">
                        Reversos de Combustibles
                    </h5>
                    <p class="text-muted small mb-4 flex-grow-1">
                        Reversos de Combustibles.
                    </p>
                    <a href="{{ route('combustibles.reversos_combustibles.index') }}" class="btn btn-warning w-100 fw-black text-uppercase py-2 shadow-sm text-dark" style="background-color: #ff6600; border-color: #ff6600; font-size: 12px; letter-spacing: 0.5px;">
                        <i class="fas fa-clipboard-check me-1"></i> Abrir Llenado
                    </a>
                </div>
            </div>
        ...
        <div class="col-md-5">
            <div class="card h-100 shadow-sm border-0 card-modulo transition-all" style="border-top: 4px solid #ff6600 !important;">
                <div class="card-body p-4 d-flex flex-column align-items-center text-center">
                    ...
                    <a href="{{ route('combustibles.mermas.index') }}" class="btn btn-warning w-100 fw-black text-uppercase py-2 shadow-sm text-dark" style="background-color: #ff6600; border-color: #ff6600; font-size: 12px; letter-spacing: 0.5px;">
                        <i class="fas fa-clipboard-check me-1"></i> Abrir Llenado
                    </a>
                </div>
            </div>
