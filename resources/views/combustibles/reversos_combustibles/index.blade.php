...
<div class="container-fluid py-4 px-4">
    ...
    <div class="mb-4 d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
        <div>
            ...
            <p class="text-muted small mb-0">Registro y auditoría de devoluciones de producto a depósitos</p>
        </div>
                ...
                <table class="table table-hover align-middle mb-0" style="min-width: 900px;">
                    <thead class="bg-light sticky-top" style="top: 0; z-index: 1;">
                        <tr class="text-uppercase text-muted" style="font-size: 12px; letter-spacing: 0.5px;">
                            ...
                            <th>Combustible</th>
                            <th>Observación</th>
                            <th class="pe-4 text-end">Litros Devueltos</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="text-center py-5 text-muted small fw-bold">
                                    <i class="fas fa-info-circle me-1 text-warning"></i> No se han encontrado registros de reversos.
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
