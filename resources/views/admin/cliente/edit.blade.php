                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="es_aliado_comercial" required class="form-select border-start-0">
                                        <option value="0" {{ old('es_aliado_comercial', $cliente->es_aliado_comercial) == 0 ? 'selected' : '' }}>No</option>
                                        <option value="1" {{ old('es_aliado_comercial', $cliente->es_aliado_comercial) == 1 ? 'selected' : '' }}>Sí</option>
                                    </select>
                                </div>
